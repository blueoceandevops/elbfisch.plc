 ...
 * MODULE    : FieldAlreadyDeclaredException.java
 * VERSION   : $Revision: $
 * DATE      : $Date: $
 * PURPOSE   : <???>
 ...
 * LOG       : $Log: FieldAlreadyDeclaredException.java,v $
 *
 ...
 */
public class FieldAlreadyDeclaredException extends Exception {

    public FieldAlreadyDeclaredException(String identifier) {
        super(identifier);
    }
