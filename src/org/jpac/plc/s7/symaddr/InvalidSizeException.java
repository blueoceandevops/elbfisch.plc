 ...
 * MODULE    : InvalidSizeException.java
 * VERSION   : $Revision: $
 * DATE      : $Date: $
 * PURPOSE   : <???>
 ...
 * LOG       : $Log: InvalidSizeException.java,v $
 *
...
public class InvalidSizeException extends Exception {
    public InvalidSizeException(String symbol, int size){
        super("symbol " + symbol + " wrong size: " + size);
    }
}
