 ...
 * MODULE    : NotAStructTypeException.java
 * VERSION   : $Revision: $
 * DATE      : $Date: $
 * PURPOSE   : 
 ...
 * LOG       : $Log: NotAStructTypeException.java,v $
 *
 ...
 */
public class NotAStructTypeException extends Exception{

    public NotAStructTypeException(String symbol) {
        super(symbol);
    }
